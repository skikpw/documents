...
\lhead{Sprawozdanie z grantu rektorskiego koła SKIK 2017}     \rhead{\today\quad\includegraphics[width=1.5cm]{logo_skik}}
...
\include{cel_projektu}
\include{struktura_stacji}
\include{rotor}
\include{sterowanie}
\include{czesc_radiowa}
\include{testy_stacji}
